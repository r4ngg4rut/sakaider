...
NETWORKS = {
    ...
    "KAIA": os.getenv("KAIA_RPC"),
    "METIS": os.getenv("METIS_RPC"),
    "GNOSIS": os.getenv("GNOSIS_RPC"),
    "BeraChain": os.getenv("BERACHAIN_RPC"),
    "SONIC": os.getenv("SONIC_RPC"),
    "PEAQ": os.getenv("PEAQ_RPC"),
    "CORE": os.getenv("CORE_RPC"),
    "FUSE": os.getenv("FUSE_RPC"),
    "MANTA": os.getenv("MANTA_RPC"),
    "MINT": os.getenv("MINT_RPC"),
    "HARMONY": os.getenv("HARMONY_RPC"),
}
